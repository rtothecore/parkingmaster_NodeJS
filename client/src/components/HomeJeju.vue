                    ...
                    <b-card-body class="pb-0">  
                        <v-layout>
                          <div>       
                            ...
                            <div id="total" style="position:absolute;left:-50px;top:-165px;height:100%;width:100%;line-height:360px;text-align:center;color:black;font-size:14px;font-weight:bold;">어제 0시</div>
                  ...
                  <b-card no-body>
                    <b-card-body class="pb-0">  
                        <v-layout>
                          <div>       
                            <div style="height: 40px; width: 100%;" />                                              
                            <div id="total" style="position:absolute;left:-50px;top:-165px;height:100%;width:100%;line-height:360px;text-align:center;color:black;font-size:14px;font-weight:bold;">그제 0시</div>
                            <div id="total" style="position:absolute;left:0px;top:-145px;height:100%;width:100%;line-height:360px;text-align:center;color:black;font-size:18px;">0/0대</div>
                          </div>
                        </v-layout>                      
                    </b-card-body>
                    ...
                    <b-card-body class="pb-0">  
                        <v-layout>
                          <div>                            
                            ...
                            <div id="total" style="position:absolute;left:120px;top:-160px;height:100%;width:100%;line-height:360px;text-align:center;color:black;font-size:14px;font-weight:bold;">2019.00.00 0시</div>
